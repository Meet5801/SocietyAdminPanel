...
const UpdateForm = ({ user, onClose, refreshUserData }) => {
  ...
  useEffect(() => {
    ...
    setFormData({
      dob: user.dob ? user.dob.split('T')[0] : '', // Set dob from API response if available
      id: user.id || '',
      name: user.username || '',
      ...
      weight: user.weight || '',
      mama_name: user.mama_name || '',
      lookup_blood_group_id: user.lookup_blood_group_id || '',
      about_me: user.about_me || '',
      interested_matrimonial: user.interested_matrimonial || false,
      interested_blood_donate: user.interested_blood_donate || '',
      lookup_pragatimandal_id: user.lookup_pragatimandal_id || '',
      lookup_occupation_id: user.lookup_occupation_id || '',
      designation: user.designation || '',
      company: user.company || '',
      occupation_address: user.occupation_address || '',
      piyar: user.piyar || '',
      mama_address: user.mama_address || '',
      lookup_village_id: user.lookup_village_id || '',
    });
  }, [user]);
  useEffect(() => {
    // Fetch Sakh data
              ...
              <div className="row">
                ...
                <div className="col-md-2">
                  ...
                  <div className="mb-3">
                    ...
                    <input type="text" className="form-control" name="height_inch" value={formData.height_foot || ''} onChange={handleInputChange} />
                  </div>
                  <div className="mb-3">
                  ...
                  <div>
                    ...
                    {formData.gender === 'female' && (
                      <div className="form-group">
                        <label htmlFor="piyar">Piyar</label>
                        <input type="text" className="form-control" id="piyar" name="piyar" value={formData.piyar} onChange={handleInputChange} />
                      </div>
                    )}
                  </div>
                  <div className="mb-3">
                ...
                <div className="col-md-2">
                  ...
                  <div className="mb-3">
                    ...
                    <input type="text" className="form-control" name="annual_income" value={formData.annual_income || ''} onChange={handleInputChange} />
                  </div>
                  <div className="mb-3">
        ...
        <div className="modal-content" >
          ...
          <div className="modal-body">
            <form onSubmit={handleSubmit} >
              <div className="row">
                <div className="col-md-3 d-flex justify-content-center align-items-center">
                  <div className="mb-3" style={{ width: '150px', height: '150px', border: '1px solid black', cursor: 'pointer', position: 'relative' }}>
                    <label className="form-label" style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }}></label>
                ...
                <div className="col-md-3">
                  ...
                  <div className="mb-3 form-check">
                    ...
                    <label className="form-check-label" htmlFor="is_verify">Verify</label>
                  </div>
                  <div className="mb-3 form-check">
                    <input type="checkbox" className="form-check-input" id="is_admin_approve" name="is_admin_approve" checked={formData.is_admin_approve} onChange={handleInputChange} />
                    <label className="form-check-label" htmlFor="is_admin_approve">Admin Approved</label>
                  </div>
                </div>
              </div>
              <div className="row">
...
const Users = () => {
    ...
    },
    {
      ...
      render: (item) => (
        <div className="d-flex">
          ...
          <Link to={`/Users/Details/${item.id}`} className="btn" style={{ height: '40px', width: '40px', border: 'none' }} title="Info">
              ...
              loading ? (
                ...
                <>
                  {userDetailsVisible[user.id].length > 0 ? (
                    <table className="table table-bordered table-striped" style={{ backgroundColor: 'rgb(6, 182, 212)', color: 'black', fontFamily: 'San Francisco, Helvetica, Arial, sans-serif' }}>
                      <thead>
                        <tr>
                          <th>Relation Type</th>
                          <th>Name</th>
                          ...
                          <tr key={index}>
                            ...
                            <td>
                              <div style={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                />
                                <div>
                                  {`${member.name}  ${member.father_or_husband_name} ${member.surname}`.length > 15 ? `${member.name} ${member.father_or_husband_name} ${member.surname}`.substring(0, 20) + '...' : `${member.name} ${member.surname} ${member.father_or_husband_name}`}
                                </div>
                              </div>
                            </td>
                    ...
                    <div style={{ justifyContent: 'center', fontWeight: 'bold' }}>
                      <p style={{ marginTop:'10px'}}>No Member Found</p>
                    </div>
                  )}
                </>
              )
  ...
  return (
    <div className="container-lg" style={{ fontFamily: 'San Francisco, Helvetica, Arial, sans-serif' }} >
      <h1>User</h1>
