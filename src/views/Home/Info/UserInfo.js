      ...
      <div style={userInfoStyle}>
        <div style={columnStyle}>
          ...
          <div className="mb-3">
            ...
            <div style={valueStyle}>
              {/* {loading ? 'Loading...' : displayUserInfo(user ? new Date(user.dob).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' }) : null)} */}
              {loading ? 'Loading...' : displayUserInfo(user && user.dob ? new Date(user.dob).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' }) : null)}
            </div>
          </div>
          <div className="mb-3">
        ...
        <div style={columnStyle}>
          ...
          <div className="mb-3">
            ...
            <div style={valueStyle}>{loading ? 'Loading...' : displayUserInfo(user ? user.education_type_name : null)}</div>
          </div>
          <div className="mb-3">
            <label style={labelStyle}>Education Sub Type:</label>
            <div style={valueStyle}>{loading ? 'Loading...' : displayUserInfo(user ? user.education_sub_type_name : null)}</div>
          </div>
          <div className="mb-3">
          ...
          <div className="mb-3">
            ...
            <div style={valueStyle}>{loading ? 'Loading...' : displayUserInfo(user ? user.pragatimandal_name : null)}</div>
          </div>
          <div className="mb-3">
            <label style={labelStyle}>Interested in Matrimonial:</label>
            <div style={valueStyle}>{loading ? 'Loading...' : displayUserInfo(user ? (user.interested_matrimonial !== null ? (user.interested_matrimonial ? 'Yes' : 'No') : '-') : null)}</div>
          </div>
          <div className="mb-3">
            <label style={labelStyle}>Interested in Blood Donation:</label>
            <div style={valueStyle}>{loading ? 'Loading...' : displayUserInfo(user ? (user.interested_blood_donation !== null ? (user.interested_blood_donation ? 'Yes' : 'No') : '-') : null)}</div>
        ...
        <div style={columnStyle}>
          <div className="mb-3">
            <label style={labelStyle}>Mama:</label>
